...
% if array is 3-dimensional and nframes = 3, assume that the third dimension is color 
% modified by K. Ohki 2011.5.10.
if nPlanes==1 & nframes==3
    array=reshape(array,h,w,1,3);
    [h,w,nframes,nPlanes] = size(array);
end
