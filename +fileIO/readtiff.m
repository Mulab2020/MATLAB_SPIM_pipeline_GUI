function [array,iframe] = readtiff(pathname,fileind,textInName,useLeicaNumbering,allowMissing);
%READTIFF Reads TIFF file or sequences of TIFF files into MATLAB array
%   array  = readtiff(pathname, fileind, textInName, useLeicaNumbering);
%
...
%$Id: readtiff.m 547 2009-07-03 04:09:39Z kenichi $
...
array = zeros(fi.height,fi.width,nframes,str);
